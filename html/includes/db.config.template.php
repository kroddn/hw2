...
define("RESEARCHSPEED", 10);
define("BUILDINGSPEED", 4);
...
define("SALLY_MIN_SIEGE_TIME", 1200);
...
define("ARMY_TIME_TO_PREPARE", 1800); // mind. 30 Mins Vorbereitung
define("ARMY_TIME_PER_1000", 1200);   // Zeit pro 1000 Einheiten in Sekunden
define("ARMY_MAX_TIME", 3600*12);    // Maximale Vorbereitungszeit 12h
define("ARMY_SPEED_FACTOR", 10);       // Armeen x mal schnell
