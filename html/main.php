...
<tr><td valign="top" colspan="2" align="center"> <?php /*
<a href="settings.php?show=account" title="Hier klicken, um für HW2 zu werben">
  <img border="0" alt="Holy-Wars 2 Banner" width="468" height="60"
   src="images/logo/hw2_anibanner1.gif"> 
</a> */ ?> <h3>Wenn ihr mich unterstützen wollt :)</h3>
<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
<input type="hidden" name="cmd" value="_s-xclick" border="0"/>
<input type="hidden" name="hosted_button_id" value="2J98MFNZKBMT4" />
<input type="image" style="border-style: none;"  src="https://www.paypalobjects.com/de_DE/DE/i/btn/btn_donate_SM.gif" border="0" name="submit" title="PayPal - The safer, easier way to pay online!" alt="Spenden mit dem PayPal-Button" />
...
<tr class="tblbody">
 ...
 <br>
   <a target="_blank" href="http://www.holy-wars2.de/wiki/index.php/Zeitung">
    <img border="0" src="images/ingame/Bote.jpg">
...
// builing troups and buildings
	...
	if(mysqli_num_rows($troops_res) == 1)
        ...
        if(mysqli_num_rows($buildings_res) < 1) {
          $num1="sind keine Auftr&auml;ge";
	} elseif(mysqli_num_rows($buildings_res) == 1) {
          $num1="ist ein Auftrag";
	} else {
          $num1="sind ".mysqli_num_rows($buildings_res)." Aufträge";
	}

	if(mysqli_num_rows($troops_res)==1) {
		$num2="eine";
	} elseif(mysqli_num_rows($troops_res)<1) {
		$num2="keine";
	} else {
		$num2=mysqli_num_rows($troops_res);
	}
...
function user_online_table() {
  ...
  echo "<tr class=\"tblbody\"><td valign=\"middle\" colspan=\"3\">Momentan sind ".mysqli_num_rows($res1)." Spieler online!</td></tr>";
