...
if(!file_exists("includes/db.inc.php")) {
  echo "Wechseln Sie vor ausf�hrung in das HTML-Verzeichnis\n";
 ...
 * Ist regtime n�mlich fr�her als starttime, dann hat der
 * Spieler 
 */
...
// Falls die Runde weniger lange als NOOB_TIME l�uft, dann verliert
// man nat�rlich keinen Noobschutz.
if($starttime + $noobtime > time()) 
{
  printf("Runde l�uft noch keine %d Tage (erst %d)\n", 
...
{
  printf("Runde l�uft bereits %d Tage\n", 
         intval( (time()-$starttime) / (24*3600) ));
}

// Alle Spieler ausw�hlen, die schon XX Tage spielen.
// activationtime wird gesetzt, wenn der Spieler seinen Namen und Startposition w�hlt
