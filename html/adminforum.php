...
//pwd
	...
	$res1=mysql_query("SELECT clanf_users.user_id as uid, clanf_users.user_password as pwdcf, player.password as pwd, player.id AS id, player.name AS name FROM clanf_users LEFT JOIN player ON player.id=clanf_users.user_id WHERE clanf_users.user_password != player.password");
...
//name
	$res1=mysql_query("SELECT clanf_users.user_id as uid, clanf_users.username, player.name, player.name AS name FROM clanf_users LEFT JOIN player ON player.id=clanf_users.user_id WHERE clanf_users.username != player.name");
...
//topics
	$res1=mysql_query("SELECT topic_id as id, topic_replies FROM clanf_topics WHERE topic_poster = '-1'");
...
//posts
	$res1=mysql_query("SELECT post_id as id FROM clanf_posts WHERE poster_id = '-1'");
