...
class MapVersion3 {
  ...
  /* eagle 27.11.04: Gibt den Dateiname der entsprechenden Stadtgrafik zur¸ck
   * param:  Religion
   *         Einwohnerzahl
   ...
   *  param:  Richtung: left,right,up,down     f¸r ganzen Sektor oder
   *                    hleft,hright,hup,hdown f¸r halben Sektor
  ...
  /**
   * Ausgabe des HTML codes f¸r den aktuellen Kartenausschnitt
   * 
   * @return unknown_type
   */
  function output() {
...
*/
    ...
    */
    ...
    while ( $field = mysql_fetch_array($fields) ) {
      ...
      // Falls koordinaten gesucht wurden, einen weiﬂen Rahmen um das Feld ziehen
      else if ($hilight) {
      ...
      // Stadt ausgeben
      if( $field['cityid'] > 0 ) {
        // Roter Rahmen f¸r aktuelle selektierte Stadt
