...
(3, 'Holzabbau', 'Ermöglicht die Erstellung von <B>Holzfällern</B>', 8, 1200, NULL, 0, 1, 0, 1, NULL, '?s1=3&s2=1&s3=0'),
(4, 'Steinabbau (für den Norden)', 'Ermöglicht die Erstellung von <B>kleinen Steinbrüchen</B>', 8, 1200, NULL, 0, 3, 0, 1, NULL, '?s1=3&s2=1&s3=5'),
(5, 'Ackerbau', 'Nach der Erforschung von Ackerbau ist es erstmals möglich, Einwohner zur <b>Gründung neuer Siedlungen</b> innerhalb des Heimatsektors zu entsenden.', 10, 1500, NULL, 0, 4, 0, 1, NULL, '?s1=3&s2=1&s3=10'),
(6, 'Schulbildung', 'Das Gebäude <B>kleine Schule</B> kann gebaut werden', 30, 1800, NULL, 0, 5, 0, 2, NULL, '?s1=3&s2=2&s3=0'),
...
(21, 'Wildjagd', 'Ermöglicht die Erstellung von <B>Jägern</B>', 50, 1800, NULL, 30, 20, 0, 1, NULL, '?s1=3&s2=1&s3=18'),
(22, 'Fischfang', 'Ermöglicht die Erstellung von <B>Fischern</B>', 50, 1800, NULL, 30, 21, 0, 1, NULL, '?s1=3&s2=1&s3=23'),
...
(204, 'Lehmgewinnung (für den Süden)', 'Ermöglicht die Erstellung von <B>kleinen Lehmgruben</B>', 8, 1200, NULL, 0, 3, 0, 1, NULL, '?s1=3&s2=1&s3=5'),
